...
\begin{bytefield}{24}
	\bitbox[]{10}{}
	\bitbox[]{16}{$\vdots$}\\[1ex]
	\begin{rightwordgroup}{\color{Cyan}Subject A}
	...
	\begin{rightwordgroup}{\color{PineGreen}Dumper}
	...
	\begin{rightwordgroup}{\color{PineGreen}$\tau0$}
	...
	\end{rightwordgroup}\\
	\memsection{0000 5000}{000f ffff}{3}{\color{Gray}-- free --}\\
	\begin{rightwordgroup}{VMX regions}
		\memsection{0000 4000}{0000 4fff}{2}{VMCS2}\\
		\memsection{0000 3000}{0000 3fff}{2}{VMCS1}\\
		\memsection{0000 2000}{0000 2fff}{2}{VMCS0}\\
		\memsection{0000 1000}{0000 1fff}{2}{VMXON}
	\end{rightwordgroup}\\
	\memsection{0000 0000}{0000 0fff}{2}{AP trampoline}
\end{bytefield}
\end{document}

...
with Mutools.Immutable_Processors.Test_Data;
with Mutools.Immutable_Processors.Test_Data.Tests;

package Mutools.Instances.Test_Data.Tests.Immutable.Test_Data is
...
--  begin read only
   package Gnattest_Data_Inst is new GNATtest_Generated.GNATtest_Standard.Mutools.Instances.Immutable.Test_Data (Test);

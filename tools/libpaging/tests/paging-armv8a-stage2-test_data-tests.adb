   ...
   begin
      ...
      Assert (Condition => Test_Utils.Equal_Files
              (Filename1 => "data/" & Fname & ".ref",
               Filename2 => "obj/" & Fname),
              Message   => "ARMv8a Stage2 Level 0 table mismatch");
--  begin read only
...
--  end read only
      ...
      Fname : constant String := "armv8a_stage2_lvl1";
   ...
   begin
      ...
      Assert (Condition => Test_Utils.Equal_Files
              (Filename1 => "data/" & Fname & ".ref",
               Filename2 => "obj/" & Fname),
              Message   => "ARMv8a Stage2 Level 1 table mismatch");
--  begin read only
...
--  end read only
      ...
      Fname     : constant String := "armv8a_stage2_lvl2";
      Base_Addr : constant Interfaces.Unsigned_64 := 16#1000_0000#;
   ...
   begin
      ...
      --  7 entries are unmapped followed by second Reference to level 3 PT.

      Tables.Add_Entry (Table => Level2,
                        Index => 264,
                        E     => Entries.Create
                          (Dst_Index   => 0,
                           Dst_Address => 16#000a_2000#,
                           Readable    => False,
                           Writable    => True,
                           Executable  => True,
                           Maps_Page   => False,
      ...
      Assert (Condition => Test_Utils.Equal_Files
              (Filename1 => "data/" & Fname & ".ref",
               Filename2 => "obj/" & Fname),
              Message   => "ARMv8a Stage2 Level 2 table mismatch");
--  begin read only
...
--  end read only
   ...
   begin
      ...
      Assert (Condition => Test_Utils.Equal_Files
              (Filename1 => "data/" & Fname & ".ref",
               Filename2 => "obj/" & Fname),
              Message   => "ARMv8a Stage2 Level 3 table mismatch");
--  begin read only

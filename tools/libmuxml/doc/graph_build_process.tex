\begin{tikzpicture}[minimum height=0.6cm]
   ...
   \node (cvr) [bluebox, right=of cmp, text width=2.2cm] {Component VR Allocator};
	\node (cm2) [apribox, right=of cvr, text width=2.2cm] {Components (pre-format)};

   \node (vra) [bluebox, right=of src] {VR Allocator};
	\node (exp) [bluebox, right=of vra] {Expander};
	\node (fma) [apribox, right=of exp] {Format A};
	\node (alo) [bluebox, below=of fma] {Allocator};

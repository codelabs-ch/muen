...
package Stage0.Pre_Checks.Test_Data.Tests is

   type Test is new GNATtest_Generated.GNATtest_Standard.Stage0.Pre_Checks.Test_Data.Test
   with null record;
...
end Stage0.Pre_Checks.Test_Data.Tests;
--  end read only

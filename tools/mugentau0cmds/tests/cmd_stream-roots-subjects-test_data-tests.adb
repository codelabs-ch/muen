...
--  placed into Cmd_Stream.Roots.Subjects.Test_Data.
...
--  begin read only
--  end read only
package body Cmd_Stream.Roots.Subjects.Test_Data.Tests is
...
--  begin read only
   procedure Test_Create_Subjects (Gnattest_T : in out Test);
...
--  end read only
      ...
      Fn     : constant String := "create_subjects.xml";
...
--  begin read only
--  end read only
end Cmd_Stream.Roots.Subjects.Test_Data.Tests;

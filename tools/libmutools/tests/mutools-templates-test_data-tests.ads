...
package Mutools.Templates.Test_Data.Tests is

   type Test is new GNATtest_Generated.GNATtest_Standard.Mutools.Templates.Test_Data.Test
   with null record;

   procedure Test_Create_4652d7 (Gnattest_T : in out Test);

...
with Mutools.Processors.Test_Data;
with Mutools.Processors.Test_Data.Tests;

package Mutools.Instances.Test_Data.Tests.Mutable.Test_Data is
...
--  begin read only
   package Gnattest_Data_Inst is new GNATtest_Generated.GNATtest_Standard.Mutools.Instances.Mutable.Test_Data (Test);

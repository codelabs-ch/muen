with Storage_Drv_Ahci_Component;
with Storage_Drv_Ahci_Component.Devices;
with Storage_Drv_Ahci_Component.Channel_Arrays;
...
is
   ...
   package Memory renames Storage_Drv_Ahci_Component.Memory;
   package Memory_Arrays renames Storage_Drv_Ahci_Component.Memory_Arrays;

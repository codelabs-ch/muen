...
package body Paging.Entries.PT_Entry_Type_Test_Data is

   Local_PT_Entry_Type : aliased GNATtest_Generated.GNATtest_Standard.Paging.Entries.PT_Entry_Type;
   procedure Set_Up (Gnattest_T : in out Test_PT_Entry_Type) is
   begin
     GNATtest_Generated.GNATtest_Standard.Paging.Entries.Table_Entry_Type_Test_Data.Table_Entry_Type_Tests.Test_Table_Entry_Type(Gnattest_T).Set_Up;
      Gnattest_T.Fixture := Local_PT_Entry_Type'Access;
   end Set_Up;

   procedure Tear_Down (Gnattest_T : in out Test_PT_Entry_Type) is
   begin

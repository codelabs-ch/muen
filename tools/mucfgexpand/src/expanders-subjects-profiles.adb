...
is
   ...
   begin
      --D @Text(Section  => 'system_src.xsd:componentProfileType',
      --D       Priority => 0).
      --D The following actions are performed for the 'linux' profile.
      --D @UL(Id       => 'linux_profile_actions',
      --D     Section  => 'system_src.xsd:componentProfileType',
      --D     Priority => 0).
      ...
      if Is_Origin then
          ...
          --D       Priority => 0).
          --D Add Linux zero-page (ZP, generated by Mugenzp)
         ...
         --D @Item(List     => 'linux_profile_actions',
         --D       Priority => 0).
         --D Add ACPI table regions (generated by Mugenacpi)
         ...
         --D @Item(List     => 'linux_profile_actions',
         --D       Priority => 0).
         --D Append sinfo address to boot parameters (\texttt{muen\_sinfo})

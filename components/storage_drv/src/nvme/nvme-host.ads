...
is
   ...
   type CAP_Part is record
      MQES      : Interfaces.Unsigned_16;        -- Maximum Queue Entries Supported, Zeros Based
      CQR       : Boolean;                       -- Contiguous Queues Required
      AMS       : Storage_Interface.Unsigned_2;  -- Arbitration Mechanism Supported
      Reserved1 : Storage_Interface.Bit_Array (3 .. 7);
      TO        : Interfaces.Unsigned_8;         -- Timeout
      DSTRD     : Storage_Interface.Unsigned_4;  -- Doorbell Stride
      NSSRS     : Boolean;                       -- NVM Subsystem Reset Supported
      CSS       : Interfaces.Unsigned_8;         -- Command Sets Supported
      BPS       : Boolean;                       -- Boot Partition Support
      CPS       : Storage_Interface.Unsigned_2;  -- Controller Power Scope
      MPSMIN    : Storage_Interface.Unsigned_4;  -- Memory Page Size Minimum
      MPSMAX    : Storage_Interface.Unsigned_4;  -- Memory Page Size Maximum
      ...
      CRMS      : Storage_Interface.Unsigned_2;  -- Controller Ready Modes Supported
   ...
   type CC_Part is record -- Offset 14h
      EN        : Boolean;                      -- Enable
      Reserved1 : Storage_Interface.Bit_Array (1 .. 3);
      CSS       : Storage_Interface.Unsigned_3; -- IO Command Set Selected
      MPS       : Storage_Interface.Unsigned_4; -- Memory Page Size
      AMS       : Storage_Interface.Unsigned_3; -- Arbitration Mechanism Selected
      SHN       : Storage_Interface.Unsigned_2; -- Shutdown Notification
      IOSQES    : Storage_Interface.Unsigned_4; -- IO SubmissionQueue Entry Size
      IOCQES    : Storage_Interface.Unsigned_4; -- IO CompletionQueue Entry Size
   ...
   type AQA_Part is record -- Offset 24h
      ASQS      : Storage_Interface.Unsigned_12; -- Admin Submission Queue Size, Zero based Value
      Reserved1 : Storage_Interface.Bit_Array (12 .. 15);
      ACQS      : Storage_Interface.Unsigned_12; -- Admin Completion Queue Size, Zero based Value
      Reserved2 : Storage_Interface.Bit_Array (28 .. 31);
   end record
   with
      Size => 32;
   ...
   type CRTO_PART is record
      CRWMT : Interfaces.Unsigned_16; -- Controller Ready With Media Timeout
      CRIMT : Interfaces.Unsigned_16; -- Controller Ready Independent of Media Timeout
   end record
   with
      Size => 32;
   ...
   type ControllerProperties is record
      ...
      INTMC      : Interfaces.Unsigned_32; -- Interrupt Mask Clear
      CC         : CC_Part;     -- Controller Configuration
      Reserved_1 : Storage_Interface.Byte_Array (0 .. 3);
      CSTS       : CSTS_Part;   -- Controller Status
      NSSR       : Interfaces.Unsigned_32; -- NVM Subsystem Reset
      AQA        : AQA_Part;    -- Admin Queue Attributes
      ASQ        : Interfaces.Unsigned_64; -- Admin Submission Queue Base Address
      ACQ        : Interfaces.Unsigned_64; -- Admin Completion Queue Base Address
      CMBLOC     : Interfaces.Unsigned_32; -- Controller Memory Buffer Location
      CMBSZ      : Interfaces.Unsigned_32; -- Controller Memory Buffer Size
      BPINFO     : Interfaces.Unsigned_32; -- Boot Partition Information
      BPRSEL     : Interfaces.Unsigned_32; -- Boot Partition Read Select
      BPMBL      : Interfaces.Unsigned_32; -- Boot Partition Memory Buffer Location
      CMBMSC     : Interfaces.Unsigned_64; -- Controller Memory Buffer Memory Space Control
      Reserved_2 : Storage_Interface.Byte_Array (0 .. 3);
      CMBSTS     : Interfaces.Unsigned_32; -- Controller Memory Buffer Status
      CMBEBS     : Interfaces.Unsigned_32; -- Controller Memory Buffer Elasticity Buffer Size
   ...
   type PSD is record
      MP          : Interfaces.Unsigned_16;       -- Maximum Power [W] * MXPS
      Reserved_1  : Storage_Interface.Bit_Array (0 .. 7);
      MXPS        : Boolean;                      -- Max Power Scale
      NOPS        : Boolean;                      -- Non-Operational State
      Reserved_2  : Storage_Interface.Bit_Array (2 .. 7);
      ENLAT       : Interfaces.Unsigned_32;       -- Entry Latency
      EXLAT       : Interfaces.Unsigned_32;       -- Exit Latency
      RRT         : Storage_Interface.Unsigned_5; -- Relative Read Throughput
      Reserved_3  : Storage_Interface.Bit_Array (5 .. 7);
      RRL         : Storage_Interface.Unsigned_5; -- Relative Read Latency
      Reserved_4  : Storage_Interface.Bit_Array (5 .. 7);
      RWT         : Storage_Interface.Unsigned_5; -- Relative Write Throughput
      Reserved_5  : Storage_Interface.Bit_Array (5 .. 7);
      RWL         : Storage_Interface.Unsigned_5; -- Relative Write Latency
      Reserved_6  : Storage_Interface.Bit_Array (5 .. 7);
      IDLP        : Interfaces.Unsigned_16;       -- Idle Power [W] * IPS
      Reserved_7  : Storage_Interface.Bit_Array (0 .. 5);
      IPS         : Storage_Interface.Unsigned_2; -- Idle Power Scale
      Reserved_8  : Storage_Interface.Bit_Array (0 .. 7);
      ACTP        : Interfaces.Unsigned_16;       -- Active Power [W] * APS
      APW         : Storage_Interface.Unsigned_3; -- Active Power Workload
      Reserved_9  : Storage_Interface.Bit_Array (3 .. 5);
      APS         : Storage_Interface.Unsigned_2; -- Active Power Scale
   ...
   type Namespace_ID_List is array (Namespace_ID_List_Index_Type) of Interfaces.Unsigned_32
   with
      Pack,
      Object_Size => 32 * 1024;

   type LBA_Format is record
      MS       : Interfaces.Unsigned_16;        -- Metadata Size
      LBADS    : Interfaces.Unsigned_8;         -- LBA Data Size
      RP       : Storage_Interface.Unsigned_2;  -- Relative Performance
   ...
   type LBA_Format_List is array (Interfaces.Unsigned_8 range 0 .. 63) of LBA_Format
   with
      Pack,
      Object_Size => 32 * 64;
   ...
   type IdentifyNamespace is record
      ...
      NSFEAT     : Interfaces.Unsigned_8;   -- Namespace Features -- type
      NLBAF      : Interfaces.Unsigned_8;   -- Number of LBA Formats
      FLABS      : Interfaces.Unsigned_8;   -- Formatted LBA Size
      MC         : Interfaces.Unsigned_8;   -- Metadata Capabilities
      DPC        : Interfaces.Unsigned_8;   -- End-to-end Data Protection Capabilities -- type
      DPS        : Interfaces.Unsigned_8;   -- End-to-end Data Protectoin Settings -- type
      NMIC       : Interfaces.Unsigned_8;   -- Namespace Multi-path I/O and Namespace Sharing Capabilities
      RESCAP     : Interfaces.Unsigned_8;   -- Reservation Capabilities
      FPI        : Interfaces.Unsigned_8;   -- Format Progress Indicator
      DLFEAT     : Interfaces.Unsigned_8;   -- Deallocate Logical Block Features
      NAWUN      : Interfaces.Unsigned_16;  -- Namespace Atomic Write Unit Normal
      NAWUPF     : Interfaces.Unsigned_16;  -- Namespace Atomic Write Unit Power Fail
      NACWU      : Interfaces.Unsigned_16;  -- Namespace Atomic Compare & Write Unit
      NABSN      : Interfaces.Unsigned_16;  -- Namespace Atomic Boundary Size Normal
      NABO       : Interfaces.Unsigned_16;  -- Namespace Atomic Boundary Offset
      NABSPF     : Interfaces.Unsigned_16;  -- Namespace Atomic Boundary Size Power Fail
      NOIOB      : Interfaces.Unsigned_16;  -- Namespace Optimal I/O Boundary
      NVMCAP     : Interfaces.Unsigned_128; -- NVM Capacity
      NPWG       : Interfaces.Unsigned_16;  -- Namespace Preferred Write Granularity
      NPWA       : Interfaces.Unsigned_16;  -- Namespace Preferred Write Alignment
      NPDG       : Interfaces.Unsigned_16;  -- Namespace Preferred Deallocate Granularity
      NPDA       : Interfaces.Unsigned_16;  -- Namespace Preferred Deallocate Alignment
      NOWS       : Interfaces.Unsigned_16;  -- Namespace Optimal Write Size
      MSSRL      : Interfaces.Unsigned_16;  -- Maximum Single Source Range Length
      MCL        : Interfaces.Unsigned_32;  -- Maximum Copy Length
      MSRC       : Interfaces.Unsigned_8;   -- Maximum Source Range Count
      Reserved_1 : Storage_Interface.Bit_Array (0 .. 87);
      ANAGRPID   : Interfaces.Unsigned_32;  -- ANA Group Identifier
      Reserved_2 : Storage_Interface.Bit_Array (0 .. 23);
      NSATTR     : Interfaces.Unsigned_8;   -- Namespace Attributes
      NVMSETID   : Interfaces.Unsigned_16;  -- NVM Set Identifier
      ENDGID     : Interfaces.Unsigned_16;  -- Endurance Group Identifier
      NGUID      : Interfaces.Unsigned_128; -- Namespace Globally Unique Identifier
      EUI64      : Interfaces.Unsigned_64;  -- IEEE Extended Unique Identifier
   ...
   type BAR_64Bit is record
      RegionType   : Boolean;
      Width        : Storage_Interface.Unsigned_2;
      Prefetchable : Boolean;
      Address1     : Storage_Interface.Unsigned_28;
   ...
   function Is_Valid return Boolean is
    (Memory_Page_Size <= Interfaces.Unsigned_8 (Storage_Interface.Unsigned_4'Last)
     and then Check_Sector_Size)
   with Ghost;

...
package Stage1.Pre_Checks.Test_Data.Tests is
   ...
   --  stage1-pre_checks.ads:29:4:Run

   procedure Test_Get_Count_1fbd7c (Gnattest_T : in out Test);
   --  stage1-pre_checks.ads:32:4:Get_Count

   procedure Test_Clear_4b4f85 (Gnattest_T : in out Test);
   --  stage1-pre_checks.ads:35:4:Clear

end Stage1.Pre_Checks.Test_Data.Tests;
--  end read only

\section{Zero Footprint Runtime}\label{sec:zfs-rts}
...
runtime system (RTS\index{RTS}) contains the minimal Ada packages required
to compile Ada code for Muen. An Ada runtime system with such a minimal
"footprint" is called Zero Footprint Runtime (ZFP\index{ZFP}). The following is

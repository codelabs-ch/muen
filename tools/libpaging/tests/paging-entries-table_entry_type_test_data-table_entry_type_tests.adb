...
--  id:2.2/3a8ec3d3f6058b3d/Get_Dst_Table_Index/1/0/
   ...
   --  paging-entries.ads:42:4:Get_Dst_Table_Index
--  end read only
...
--  id:2.2/17828eb746e595fc/Get_Dst_Address/1/0/
   ...
   --  paging-entries.ads:45:4:Get_Dst_Address
--  end read only
...
--  id:2.2/c21cb91d98cddfe9/Set_Dst_Address/1/0/
   ...
   --  paging-entries.ads:50:4:Set_Dst_Address
--  end read only
...
--  id:2.2/b4af0c02e50428f8/Is_Present/1/0/
   ...
   --  paging-entries.ads:55:4:Is_Present
--  end read only
...
--  id:2.2/a3f083bb8d1d64f6/Is_Readable/1/0/
   ...
   --  paging-entries.ads:59:4:Is_Readable
--  end read only
...
--  id:2.2/4b4e3f0710c4652e/Is_Writable/1/0/
   ...
   --  paging-entries.ads:63:4:Is_Writable
--  end read only
...
--  id:2.2/3e2d635bdaa67355/Is_Executable/1/0/
   ...
   --  paging-entries.ads:67:4:Is_Executable
--  end read only
...
--  id:2.2/4c3f511d997b690a/Maps_Page/1/0/
   ...
   --  paging-entries.ads:70:4:Maps_Page
--  end read only
...
--  id:2.2/aeaec3a5b655240a/Is_Global/1/0/
   ...
   --  paging-entries.ads:73:4:Is_Global
--  end read only
...
--  id:2.2/b6648c05e48c90b4/Get_Caching/1/0/
   ...
   --  paging-entries.ads:76:4:Get_Caching
--  end read only

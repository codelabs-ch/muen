...
The
\texttt{Mugenhwcfg}\footnote{\url{https://git.codelabs.ch/cgit/muen/mugenhwcfg.git}}
...
The
\texttt{Mugenschedcfg}\footnote{\url{https://git.codelabs.ch/cgit/muen/mugenschedcfg.git}}

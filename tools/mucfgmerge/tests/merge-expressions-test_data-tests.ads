...
package Merge.Expressions.Test_Data.Tests is

   type Test is new GNATtest_Generated.GNATtest_Standard.Merge.Expressions.Test_Data.Test
   with null record;

   procedure Test_Expand_150aa9 (Gnattest_T : in out Test);

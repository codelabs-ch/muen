...
--  placed into Cmd_Stream.Roots.Utils.Test_Data.
...
--  begin read only
--  end read only
package body Cmd_Stream.Roots.Utils.Test_Data.Tests is
...
--  begin read only
   procedure Test_Assign_Memory (Gnattest_T : in out Test);
...
--  begin read only
--  end read only
end Cmd_Stream.Roots.Utils.Test_Data.Tests;

...
package Mutools.XML_Utils.Test_Data.Tests is
   ...
   procedure Test_Add_Resource_3ac0bf (Gnattest_T : in out Test);
   --  mutools-xml_utils.ads:33:4:Add_Resource

   procedure Test_Add_Memory_Region_6142bd (Gnattest_T : in out Test);
   --  mutools-xml_utils.ads:39:4:Add_Memory_Region

   procedure Test_Add_Memory_Region_741476 (Gnattest_T : in out Test);
   --  mutools-xml_utils.ads:50:4:Add_Memory_Region

   procedure Test_Add_Memory_Region_4bc9f0 (Gnattest_T : in out Test);
   --  mutools-xml_utils.ads:63:4:Add_Memory_Region

   procedure Test_Create_Memory_Node_4c3d32 (Gnattest_T : in out Test);
   --  mutools-xml_utils.ads:74:4:Create_Memory_Node

...
Annotations are processed by the SPARK tools. These tools perform static
...
introduced by John Rushby in a paper published in 1981 \cite{rushby1981}. While
the original paper describes a distributed system, it is more illustrative to
think of it as multiple components which behave as if they were each running on

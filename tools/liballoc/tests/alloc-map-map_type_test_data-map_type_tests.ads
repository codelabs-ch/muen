...
package Alloc.Map.Map_Type_Test_Data.Map_Type_Tests is

   type Test_Map_Type is new
     GNATtest_Generated.GNATtest_Standard.Alloc.Map.Map_Type_Test_Data.Test_Map_Type with null record;

   procedure Test_Insert_Device_Region_ec5f2d (Gnattest_T : in out Test_Map_Type);
   --  alloc-map.ads:42:4:Insert_Device_Region

   procedure Test_Insert_Empty_Region_67dfce (Gnattest_T : in out Test_Map_Type);

...
employing the Bochs IA-32 emulator \cite{bochs}. Among many other features,
Bochs has support for multiple processors, APIC emulation and VMX extensions.
Figure \ref{fig:bochs} shows the Bochs emulator running the Muen example system

...
package body CRC32 is
   ...
   Init   : constant CRC_32 := 16#FFFF_FFFF#;  -- Initial value
   XorOut : constant CRC_32 := 16#FFFF_FFFF#;  -- To compute final result.
   ...
   Table : constant array (CRC_32 range 0 .. 255) of CRC_32 :=
   ...
   function Get_Value (C : CRC_32) return Interfaces.Unsigned_32 is
   begin
   ...
   procedure Initialize (C : out CRC_32) is
   begin
      C := Init;
   end Initialize;
   ...
   procedure Update (C : in out CRC_32; Value : Character) is
      V : constant CRC_32 := CRC_32 (Character'Pos (Value));
   begin

...
is
   --D @Section Id => validation-devdom, Label => Device Domains, Parent => validation, Priority => 0
   --D @Text Section => validation-devdom, Priority => 0
   ...
   --D @UL Id => validators_devdom, Section => validation-devdom, Priority => 0

   --D @Item List => validators_devdom, Priority => 0

...
is
   ...
   begin
      ...
      Procs.Register
        (Process => Memory.Add_Scheduling_Partition_Info_Regions'Access);
      ...
      Procs.Register
        (Process => Kernel.Add_Sched_Partition_Info_Mappings'Access);
      ...
      Procs.Register
        (Process => Subjects.Add_Sched_Partition_Info_Mappings'Access);

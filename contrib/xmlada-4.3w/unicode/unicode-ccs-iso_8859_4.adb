...
package body Unicode.CCS.Iso_8859_4 is
   ...
   To_Unicode_Arr : constant Conversion_Arr :=
     (16#00A1# => Latin_Capital_Letter_A_With_Ogonek,
      ...
      16#00A3# => Latin_Capital_Letter_R_With_Cedilla,
      16#00A4# => Currency_Sign,
      16#00A5# => Latin_Capital_Letter_I_With_Tilde,
      16#00A6# => Latin_Capital_Letter_L_With_Cedilla,
      16#00A7# => Section_Sign,
      16#00A8# => Diaeresis,
      16#00A9# => Latin_Capital_Letter_S_With_Caron,
      16#00AA# => Latin_Capital_Letter_E_With_Macron,
      16#00AB# => Latin_Capital_Letter_G_With_Cedilla,
      16#00AC# => Latin_Capital_Letter_T_With_Stroke,
      16#00AD# => Soft_Hyphen,
      ...
      16#00B2# => Ogonek,
      16#00B3# => Latin_Small_Letter_R_With_Cedilla,
      16#00B4# => Acute_Accent,
      16#00B5# => Latin_Small_Letter_I_With_Tilde,
      16#00B6# => Latin_Small_Letter_L_With_Cedilla,
      16#00B7# => Caron,
      16#00B8# => Cedilla,
      16#00B9# => Latin_Small_Letter_S_With_Caron,
      16#00BA# => Latin_Small_Letter_E_With_Macron,
      16#00BB# => Latin_Small_Letter_G_With_Cedilla,
      16#00BC# => Latin_Small_Letter_T_With_Stroke,
      16#00BD# => Latin_Capital_Letter_Eng,
      16#00BE# => Latin_Small_Letter_Z_With_Caron,
      16#00BF# => Latin_Small_Letter_Eng,
      16#00C0# => Latin_Capital_Letter_A_With_Macron,
      ...
      16#00C7# => Latin_Capital_Letter_I_With_Ogonek,
      ...
      16#00CC# => Latin_Capital_Letter_E_With_Dot_Above,
      16#00CD# => Latin_Capital_Letter_I_With_Acute,
      16#00CE# => Latin_Capital_Letter_I_With_Circumflex,
      16#00CF# => Latin_Capital_Letter_I_With_Macron,
      16#00D0# => Latin_Capital_Letter_D_With_Stroke,
      16#00D1# => Latin_Capital_Letter_N_With_Cedilla,
      16#00D2# => Latin_Capital_Letter_O_With_Macron,
      16#00D3# => Latin_Capital_Letter_K_With_Cedilla,
      ...
      16#00D9# => Latin_Capital_Letter_U_With_Ogonek,
      ...
      16#00DE# => Latin_Capital_Letter_U_With_Macron,
      16#00DF# => Latin_Small_Letter_Sharp_S,
      16#00E0# => Latin_Small_Letter_A_With_Macron,
      ...
      16#00E7# => Latin_Small_Letter_I_With_Ogonek,
      ...
      16#00EC# => Latin_Small_Letter_E_With_Dot_Above,
      16#00ED# => Latin_Small_Letter_I_With_Acute,
      16#00EE# => Latin_Small_Letter_I_With_Circumflex,
      16#00EF# => Latin_Small_Letter_I_With_Macron,
      16#00F0# => Latin_Small_Letter_D_With_Stroke,
      16#00F1# => Latin_Small_Letter_N_With_Cedilla,
      16#00F2# => Latin_Small_Letter_O_With_Macron,
      16#00F3# => Latin_Small_Letter_K_With_Cedilla,
      ...
      16#00F9# => Latin_Small_Letter_U_With_Ogonek,
      ...
      16#00FD# => Latin_Small_Letter_U_With_Tilde,
      16#00FE# => Latin_Small_Letter_U_With_Macron,
      16#00FF# => Dot_Above);
   ...
   function To_Iso_8859_4 (Char : Unicode_Char) return Unicode_Char is
   begin
      case Char is
         when Latin_Capital_Letter_A_With_Ogonek     => return 16#00A1#;
         when Latin_Small_Letter_Kra                 => return 16#00A2#;
         when Latin_Capital_Letter_R_With_Cedilla    => return 16#00A3#;
         when Currency_Sign                          => return 16#00A4#;
         when Latin_Capital_Letter_I_With_Tilde      => return 16#00A5#;
         when Latin_Capital_Letter_L_With_Cedilla    => return 16#00A6#;
         when Latin_Capital_Letter_S_With_Caron      => return 16#00A9#;
         when Latin_Capital_Letter_E_With_Macron     => return 16#00AA#;
         when Latin_Capital_Letter_G_With_Cedilla    => return 16#00AB#;
         when Latin_Capital_Letter_T_With_Stroke     => return 16#00AC#;
         ...
         when Latin_Small_Letter_R_With_Cedilla      => return 16#00B3#;
         when Latin_Small_Letter_I_With_Tilde        => return 16#00B5#;
         when Latin_Small_Letter_L_With_Cedilla      => return 16#00B6#;
         when Caron                                  => return 16#00B7#;
         when Latin_Small_Letter_S_With_Caron        => return 16#00B9#;
         when Latin_Small_Letter_E_With_Macron       => return 16#00BA#;
         when Latin_Small_Letter_G_With_Cedilla      => return 16#00BB#;
         when Latin_Small_Letter_T_With_Stroke       => return 16#00BC#;
         when Latin_Capital_Letter_Eng               => return 16#00BD#;
         when Latin_Small_Letter_Z_With_Caron        => return 16#00BE#;
         when Latin_Small_Letter_Eng                 => return 16#00BF#;
         when Latin_Capital_Letter_A_With_Macron     => return 16#00C0#;
         when Latin_Capital_Letter_I_With_Ogonek     => return 16#00C7#;
         when Latin_Capital_Letter_C_With_Caron      => return 16#00C8#;
         when Latin_Capital_Letter_E_With_Ogonek     => return 16#00CA#;
         when Latin_Capital_Letter_E_With_Dot_Above  => return 16#00CC#;
         when Latin_Capital_Letter_I_With_Macron     => return 16#00CF#;
         when Latin_Capital_Letter_D_With_Stroke     => return 16#00D0#;
         when Latin_Capital_Letter_N_With_Cedilla    => return 16#00D1#;
         when Latin_Capital_Letter_O_With_Macron     => return 16#00D2#;
         when Latin_Capital_Letter_K_With_Cedilla    => return 16#00D3#;
         when Latin_Capital_Letter_U_With_Ogonek     => return 16#00D9#;
         when Latin_Capital_Letter_Y_With_Acute      => return 16#00DD#;
         when Latin_Capital_Letter_U_With_Macron     => return 16#00DE#;
         when Latin_Small_Letter_A_With_Macron       => return 16#00E0#;
         when Latin_Small_Letter_I_With_Ogonek       => return 16#00E7#;
         when Latin_Small_Letter_C_With_Caron        => return 16#00E8#;
         when Latin_Small_Letter_E_With_Ogonek       => return 16#00EA#;
         when Latin_Small_Letter_E_With_Dot_Above    => return 16#00EC#;
         when Latin_Small_Letter_I_With_Macron       => return 16#00EF#;
         when Latin_Small_Letter_D_With_Stroke       => return 16#00F0#;
         when Latin_Small_Letter_N_With_Cedilla      => return 16#00F1#;
         when Latin_Small_Letter_O_With_Macron       => return 16#00F2#;
         when Latin_Small_Letter_K_With_Cedilla      => return 16#00F3#;
         when Latin_Small_Letter_U_With_Ogonek       => return 16#00F9#;
         when Latin_Small_Letter_U_With_Tilde        => return 16#00FD#;
         when Latin_Small_Letter_U_With_Macron       => return 16#00FE#;

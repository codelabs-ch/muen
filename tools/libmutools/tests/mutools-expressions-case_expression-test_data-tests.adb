...
--  begin read only
   ...
   procedure Test_Evaluate_Case_Node_Frame_a797cc (Gnattest_T : in out Test) renames Test_Evaluate_Case_Node_Frame;
--  id:2.2/a797cc59c56ba074/Evaluate_Case_Node_Frame/1/0/
...
--  begin read only
   ...
   procedure Test_Case_Expression_Evaluation_d75d10 (Gnattest_T : in out Test) renames Test_Case_Expression_Evaluation;
--  id:2.2/d75d10d1e07709cf/Case_Expression_Evaluation/1/0/

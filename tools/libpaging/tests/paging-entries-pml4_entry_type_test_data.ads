...
package Paging.Entries.PML4_Entry_Type_Test_Data is

--  begin read only
   type Test_PML4_Entry_Type is new
...
--  end read only
   ...
   procedure Set_Up (Gnattest_T : in out Test_PML4_Entry_Type);
   procedure Tear_Down (Gnattest_T : in out Test_PML4_Entry_Type);

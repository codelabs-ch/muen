...
The \texttt{mugenschedcfg}\footnote{\url{https://git.codelabs.ch/?p=muen/mugenschedcfg.git}}
tool can be used to automatically generate scheduling plans from a given
scheduling configuration. Consult the project README and examples on how to use
the tool.

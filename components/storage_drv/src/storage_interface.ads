...
is
   ...
   Command_Lists_Size    : constant := (Ports_Config.Port_Range'Last + 1) * 16#400#;

   Command_Table_Address : constant :=
      Command_Lists_Address + Command_Lists_Size;
   Command_Table_Size    : constant := (Ports_Config.Port_Range'Last + 1) * 16#100#;

   Fis_Base_Address      : constant :=
      Command_Table_Address + Command_Table_Size;
   Fis_Table_Size        : constant := (Ports_Config.Port_Range'Last + 1) * 16#100#;
   ...
   type Bit_Array_8 is array (0 .. 7) of Boolean
   with Pack;
   ...
   subtype Devs_Array is Bit_Array (0 .. Integer (Ports_Config.Port_Range'Last));
   ...
   type Internal_Device_Array_Type is array (Ports_Config.Devices_Range)
   ...
   type Ports_Array is array (Ports_Config.Ports_Array_Range) of Port_Type;

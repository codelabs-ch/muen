...
--  begin read only
   procedure Test_Hardware_System_Board_Presence (Gnattest_T : in out Test);
   procedure Test_Hardware_System_Board_Presence_d95db5 (Gnattest_T : in out Test) renames Test_Hardware_System_Board_Presence;
--  id:2.2/d95db537c8dec638/Hardware_System_Board_Presence/1/0/
   procedure Test_Hardware_System_Board_Presence (Gnattest_T : in out Test) is
...
--  end read only
   ...
   begin
      ...
      Hardware_System_Board_Presence (XML_Data => Policy);
...
--  begin read only
   end Test_Hardware_System_Board_Presence;
--  end read only

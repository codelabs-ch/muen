...
A Programmable Interrupt Controller (PIC\index{PIC}) is used to combine several
...
multiprocessor (MP\index{MP}) systems containing multiple processor cores. To
...
APIC (LAPIC\index{LAPIC}) in each CPU of the system and the I/O APIC.
...
sends and receives interprocessor interrupt messages (IPI\index{IPI}) from and
